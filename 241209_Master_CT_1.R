...
server <- function(input, output, session) {
  ...
  output$view_explanation <- renderText({
    switch(input$view_mode,
           "fuel" = "Fuel Poverty describes households that cannot afford to
           keep their home adequately heated at a reasonable cost, factoring in
           their income and home energy-efficiency",
           "mortality" = "The measure of excess deaths occurring in winter 
           months compared to non-winter months. Winter Mortality Index (WMI) 
           indicator describes the ratio of excess deaths in the winter months 
           compared with the average number of deaths in the summer months",
           "bivariate" = "Bivariate graph shows the relationship between fuel 
           poverty rates and winter mortality across regions"
    )
  })
